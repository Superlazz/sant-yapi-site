    ...
    <main className="min-h-screen bg-[#080807] text-stone-100">
      ...
      <section id="iletisim" className="border-t border-white/10 bg-[#050504]">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-[1fr_0.9fr] lg:px-8">
          ...
          <form className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6" onSubmit={(event) => event.preventDefault()}>
            <div className="grid gap-4">
              <input aria-label="Adınız / Firma adınız" className="rounded-2xl border border-white/10 bg-black/30 px-5 py-4 text-white outline-none placeholder:text-stone-500 focus:border-yellow-400" placeholder="Adınız / Firma adınız" />
              <input aria-label="Telefon veya e-posta" className="rounded-2xl border border-white/10 bg-black/30 px-5 py-4 text-white outline-none placeholder:text-stone-500 focus:border-yellow-400" placeholder="Telefon veya e-posta" />
              <select aria-label="Hizmet seçiniz" className="rounded-2xl border border-white/10 bg-black/30 px-5 py-4 text-stone-300 outline-none focus:border-yellow-400" defaultValue="">
              ...
              <textarea aria-label="Projeniz hakkında kısa bilgi" className="min-h-36 rounded-2xl border border-white/10 bg-black/30 px-5 py-4 text-white outline-none placeholder:text-stone-500 focus:border-yellow-400" placeholder="Projeniz hakkında kısa bilgi" />
              <button type="submit" className="rounded-full bg-yellow-400 px-7 py-4 font-bold text-black transition hover:bg-yellow-300">
                Mesaj Gönder
              </button>
            </div>
          </form>
